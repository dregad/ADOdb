...
if (!defined('_ADODB_LAYER')) {
    ...
    global
        ...
        $ADODB_GETONE_EOF,
        $ADODB_QUOTE_FIELDNAMES; // Allows you to force quotes (backticks) around field names
                                 // in queries generated by getinsertsql and getupdatesql.
    ...
    // 3 = force value. Value is left as it is. Php null and string 'null' are set to sql NULL values
    //     and empty fields '' are set to empty '' sql values.
...
*/
    ...
    //
        ...
        public $maxblobsize = 262144;       // maximum size of blobs or large text fields (262144 = 256K)
    ...
    // memcache
        ...
        public $sysUTimeStamp = false;      // name of function that returns the current timestamp
                                            // accurate to the microsecond or nearest fraction
        public $arrayClass = 'ADORecordSet_array';  // name of class used to generate array recordsets,
                                                    // which are pre-downloaded recordsets
        ...
        public $null2null = 'null';         // in autoexecute/getinsertsql/getupdatesql,
                                            // this value will be converted to a null
        ...
        */
        ...
        public function getActiveRecordsClass(
            ...
            return adodb_GetActiveRecordsClass(
                $this,
                $class,
                $table,
                $whereOrderBy,
...
*/
         ...
         *               Each element represents an index, and is itself an associative array:
         *                  Array(
         *                    [name_of_index] => Array(
    ...
    */
    ...
    class ADORecordSet implements IteratorAggregate
    {
        ...
        public $sql;                // sql text
        public $EOF = false;        // Indicates that the current record position is
        ...
        public function getAssoc($force_array = false, $first2cols = false)
        {
            ...
            if (!$first2cols && ($cols > 2 || $force_array)) {
                ...
                if ($ADODB_EXTENSION) {
                    ...
                    if ($numIndex) {
                        while (!$this->EOF) {
                            // some bug in mssql PHP 4.02 -- doesn't handle references
                            // properly so we FORCE creating a new string
